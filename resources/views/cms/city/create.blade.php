                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['admin.city.store'], 'class'=>'form-horizontal group-border stripped', 'id'=>'form')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            ...
                                            <a class="btn btn-default ml15" href="{{route('admin.city.index')}}">返回</a>
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
                                    {{ Form::close() }}
