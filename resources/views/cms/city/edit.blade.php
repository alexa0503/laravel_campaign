                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['admin.city.update',$city->id], 'class'=>'form-horizontal group-border stripped', 'method'=>'PUT', 'id'=>'form')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <select class="form-control" name="province" id="province">
                                                ...
                                                <option value="{{$province->id}}" @if ($province->id == $city->province_id) selected="selected" @endif>{{$province->title}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group hide">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="order_no" id="order_no" class="form-control" value="{{$city->order_no}}">
...
$(document).ready(function() {
    ...
    $('#form').ajaxForm({
        ...
        success: function() {
            ...
            location.href='{{route("admin.city.index")}}?province='+$('#province').val();
        },
        error: function(xhr){
