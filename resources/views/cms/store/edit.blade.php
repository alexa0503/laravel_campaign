                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['admin.store.update',$store->id], 'class'=>'form-horizontal group-border stripped', 'method'=>'PUT', 'id'=>'form')) }}
                                    ...
                                    <div class="form-group hide">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="order_no" id="order_no" class="form-control" value="{{$store->order_no}}">
                                            <label class="help-block" for="title"></label>
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
...
$(document).ready(function() {
    var province = '{{$store->city->province_id}}';
    var city = '{{$store->city_id}}';
    $.getJSON('{{url("api/cities")}}',function(data){
        var html;
        $.each(data,function(key,value){
            html += '<option value="'+key+'">'+value.title+'</option>'
        })
        $('#province').append(html).val(province);
        getCities(data,city);
